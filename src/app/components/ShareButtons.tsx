      ...
      <div className={styles.buttonsGroup}>
        ...
        {vehicleId && (
          <button
            ...
            style={status !== "APPROVED" ? { opacity: 0.4, cursor: "not-allowed", filter: "grayscale(100%)" } : {}}
            data-tooltip={status === "APPROVED" ? "Generar tarjeta para Historia de Instagram" : "Generación de tarjeta disponible al aprobar publicación"}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        {vehicleId && (
          <button
            ...
            disabled={status !== "APPROVED" || downloadingCard}
            className={`${styles.shareBtn} ${styles.downloadCard}`}
            style={status !== "APPROVED" ? { opacity: 0.4, cursor: "not-allowed" } : {}}
            data-tooltip={status === "APPROVED" ? "Descargar tarjeta para historias o estados" : "Generación de tarjeta disponible al aprobar publicación"}
          >
            {downloadingCard ? (
        ...
        <a
          ...
          data-tooltip="Compartir por Facebook"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a
          ...
          data-tooltip="Compartir por Twitter"
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
